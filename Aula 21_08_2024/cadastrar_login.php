    ...
    <div class="container d-flex justify-content-center">
        <form class="form" method="post">
            ...
            <div class="inputForm">
                ...
                <input type="text" class="input" placeholder="Entre com seu nome" name="bt_nome" required/>
            </div>
            <div class="flex-column">
                <label>Email: </label>
            </div>
            <div class="inputForm">
                ...
                <input type="text" class="input" placeholder="Entre com email" name="bt_email" required/>
            </div>
            ...
            <input type="submit" class="button-submit" value="Cadastrar"/>
            <p class="p">Você já tem uma conta? <a class="span" href="login.php">Login</a></p>
